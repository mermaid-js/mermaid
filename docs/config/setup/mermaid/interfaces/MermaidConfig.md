...
> `optional` **forceModel**: `"EADES"` | `"FRUCHTERMAN_REINGOLD"`
...
> `optional` **forceRepulsion**: `number`
...
#### stressDesiredEdgeLength?

> `optional` **stressDesiredEdgeLength**: `number`
...
> `optional` **stressIterationLimit**: `number`
