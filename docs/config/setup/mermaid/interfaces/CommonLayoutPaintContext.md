...
> **insertNode**: (`elem`, `node`, `renderOptions`) => `Promise`<`D3Selection`<`SVGGElement`> | `Selection`<`SVGGElement`, `unknown`, `Element` | `null`, `unknown`> | `D3Selection`<`SVGAElement`>>
...
`Promise`<`D3Selection`<`SVGGElement`> | `Selection`<`SVGGElement`, `unknown`, `Element` | `null`, `unknown`> | `D3Selection`<`SVGAElement`>>
