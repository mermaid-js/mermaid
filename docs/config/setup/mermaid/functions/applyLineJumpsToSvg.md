...
Defined in: [packages/mermaid/src/rendering-util/rendering-elements/lineJump.ts:560](https://github.com/mermaid-js/mermaid/blob/master/packages/mermaid/src/rendering-util/rendering-elements/lineJump.ts#L560)
