...
If you are new to mermaid, read the [Getting Started](**NEEDS UPDATE** n00b-gettingStarted.md) and [Overview](**NEEDS UPDATE** n00b-overview.md) sections, to learn the basics of mermaid.
