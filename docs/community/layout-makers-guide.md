...
>
> ## Please edit the corresponding file in [/packages/mermaid/src/docs/community/layout-makers-guide.md](../../packages/mermaid/src/docs/community/layout-makers-guide.md).
