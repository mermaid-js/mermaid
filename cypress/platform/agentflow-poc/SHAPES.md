...
| `lean-right` | `in-out`         | Parallelogram (right-leaning)                                   | User-defined keys                                      | An input value or parameter entering the flow from outside. The slant visually suggests data in motion.                                                                  |
