...
const supportedConfig = {
  ...
  minNodeWidth: 120,
  actorFontSize: 14,
  actorFontFamily: '"Open Sans Variable", "Open Sans", sans-serif',
  actorFontWeight: 'normal',
  usecaseFontSize: 12,
  usecaseFontFamily: '"Open Sans Variable", "Open Sans", sans-serif',
  ...
  it('defines the exact usecase defaults in the authoritative schema', () => {
    expect(usecaseDefinition).toMatchObject({
      ...
      properties: {
        ...
        actorFontFamily: { default: '"Open Sans Variable", "Open Sans", sans-serif' },
        actorFontWeight: { default: 'normal' },
        usecaseFontSize: { default: 12 },
        usecaseFontFamily: { default: '"Open Sans Variable", "Open Sans", sans-serif' },
