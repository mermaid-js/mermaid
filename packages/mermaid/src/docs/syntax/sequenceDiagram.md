...
| actorFontFamily   | Sets the font family for the actor's description                                                                                           | "Open Sans Variable", "Open Sans", sans-serif                                                       |
| actorFontWeight   | Sets the font weight for the actor's description                                                                                           | "Open Sans Variable", "Open Sans", sans-serif                                                       |
| noteFontSize      | Sets the font size for actor-attached notes                                                                                                | 14                                                                                                  |
| noteFontFamily    | Sets the font family for actor-attached notes                                                                                              | "Atkinson Hyperlegible Next Variable", "Atkinson Hyperlegible Next", "trebuchet ms", verdana, arial |
| noteFontWeight    | Sets the font weight for actor-attached notes                                                                                              | "Atkinson Hyperlegible Next Variable", "Atkinson Hyperlegible Next", "trebuchet ms", verdana, arial |
| noteAlign         | Sets the text alignment for text in actor-attached notes                                                                                   | center                                                                                              |
| messageFontSize   | Sets the font size for actor<->actor messages                                                                                              | 16                                                                                                  |
| messageFontFamily | Sets the font family for actor<->actor messages                                                                                            | "Atkinson Hyperlegible Next Variable", "Atkinson Hyperlegible Next", "trebuchet ms", verdana, arial |
| messageFontWeight | Sets the font weight for actor<->actor messages                                                                                            | "Atkinson Hyperlegible Next Variable", "Atkinson Hyperlegible Next", "trebuchet ms", verdana, arial |
