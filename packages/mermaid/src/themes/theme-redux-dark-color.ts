...
import type { NumberedThemeKey, ReduxThemeVariables, DarkThemeVariables } from './theme-types.js';
...
interface Theme extends ReduxThemeVariables, DarkThemeVariables {}
...
class Theme {
  ...
  updateColors() {
    ...
    for (let i = 0; i < this.THEME_COLOR_LIMIT; i++) {
      this[('cScaleLabel' + i) as NumberedThemeKey<Theme, 'cScaleLabel'>] = darken(
