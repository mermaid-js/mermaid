...
import type { NumberedThemeKey, ReduxThemeVariables } from './theme-types.js';
...
interface Theme extends ReduxThemeVariables {}
...
class Theme {
  ...
  updateColors() {
    ...
    //     this[('cScale' + i) as NumberedThemeKey<Theme, 'cScale'>] = darken(this[('cScale' + i) as NumberedThemeKey<Theme, 'cScale'>], 75);
    //   }
    // } else {
    //   for (let i = 0; i < this.THEME_COLOR_LIMIT; i++) {
    //     this[('cScale' + i) as NumberedThemeKey<Theme, 'cScale'>] = darken(this[('cScale' + i) as NumberedThemeKey<Theme, 'cScale'>], 25);
    //   }
    // }
    ...
    for (let i = 0; i < this.THEME_COLOR_LIMIT; i++) {
      if (this.darkMode) {
        ...
        this[('cScalePeer' + i) as NumberedThemeKey<Theme, 'cScalePeer'>] =
          this[('cScalePeer' + i) as NumberedThemeKey<Theme, 'cScalePeer'>] ||
          darken(this[('cScale' + i) as NumberedThemeKey<Theme, 'cScale'>], 10);
      }
    }
