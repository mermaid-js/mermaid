...
export const DEFAULT_HOLA_OPTIONS: HolaOptions = {
  ...
  // Class-diagram extension, aggregation, and composition markers are 17.25px
  // long. Leave a small visible run beyond the marker before the first bend.
  minTerminalLegLength: 18,
