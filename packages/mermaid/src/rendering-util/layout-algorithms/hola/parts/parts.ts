 ...
 * parts is just finding the connected components — the `core/` stage's own
...
import { weaklyConnectedComponents } from '../core/components/components.js';
import { isPureTree } from '../core/decomposition/peelCoreAndTrees.js';
import type { FlattenResult } from '../core/adapter/flattenFlowchart.js';
import type { HolaGraph } from '../core/model.js';
