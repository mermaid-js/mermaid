...
import type { Bounds, Cardinal, Direction, HolaNode, Ordinal, Rect } from '../core/model.js';
import {
  ALL_DIRECTIONS,
  boundsHeight,
  boundsWidth,
...
import {
  ...
  ordinalComponents,
  ROTATION_FOR_GROWTH,
} from '../core/placement/placeTrees.js';
import type { PlaceableTree } from '../core/placement/placeTrees.js';
import type { PlanarisedCore } from '../core/planarization/planarise.js';
import { transformTreeLayout, treePerimeter } from '../core/trees/symmetricTreeLayout.js';
