...
const DEFAULT_GITGRAPH_CONFIG_A: Required<GitGraphDiagramConfig> = DEFAULT_CONFIG.gitGraph;
const getConfigA = (): Required<GitGraphDiagramConfig> => {
  const config = cleanAndMerge({
    ...DEFAULT_GITGRAPH_CONFIG_A,
...
export const branch = function (branchDB: BranchDB) {
  ...
  name = common.sanitizeText(name, getConfigA());
...
export const checkout = function (branch: string) {
  branch = common.sanitizeText(branch, getConfigA());
...
// const db1: GitGraphDB = {
//   commitType,
//   getConfig: getConfigA,
//   setDirection,
//   setOptions,
//   getOptions,
//   commit,
