...
export const draw = async function (
  ...
  // Handle root and document for sandbox mode
  let sandboxElement;
  ...
  // Add <desc> for screen readers
  svg
    .append('desc')
    .attr('id', `${id}-desc`)
    .text(
      diag.db.getAccDescription() ||
        'Flowchart diagram generated by Mermaid'
    );
  ...
  /* =====================================================
     Node Link Wrapping (unchanged logic)
     ===================================================== */
