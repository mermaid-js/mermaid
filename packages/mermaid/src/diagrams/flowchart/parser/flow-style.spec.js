...
describe('[Style] when parsing', () => {
  ...
  it('should handle styles for vertices', function () {
    flow.parser.parse('graph TD;style Q background:#fff;');
  ...
  it('should handle multiple styles for a vortex', function () {
    flow.parser.parse('graph TD;style R background:#fff,border:1px solid red;');
  ...
  it('should handle styles and graph definitions in a graph', function () {
    flow.parser.parse('graph TD;style T background:#bbb,border:1px solid red;');
    // flow.parser.parse('graph TD;style T background: #bbb;');
  ...
  it('should be possible to declare a class', function () {
    flow.parser.parse('graph TD;classDef exClass background:#bbb,border:1px solid red;');
    // flow.parser.parse('graph TD;style T background: #bbb;');
  ...
  it('should be possible to declare a class with a dot in the style', function () {
    flow.parser.parse('graph TD;classDef exClass background:#bbb,border:1.5px solid red;');
    // flow.parser.parse('graph TD;style T background: #bbb;');
