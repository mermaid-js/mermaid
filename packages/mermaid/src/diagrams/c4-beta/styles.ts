...
const getStyles = (options: C4BetaStyleOptions) =>
   ...
   * .node rect rule above; each kind contributes its border colour here and reuses the
   * identity colour for its label text below.
  ...
  .c4-infrastructureNode circle {
    stroke: ${options.c4InfrastructureBorder};
  }
