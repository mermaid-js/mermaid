...
- **`reads` / `writes` arrays removed.** Data passes between steps implicitly; if a step
  ...
  shared-state *model* survives in prose; the bookkeeping syntax is gone.
