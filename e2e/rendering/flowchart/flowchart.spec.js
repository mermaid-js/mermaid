...
test.describe('Graph', () => {
  test('1: should render a simple flowchart no htmlLabels', async ({ page }, testInfo) => {
  ...
  test('2: should render a simple flowchart with htmlLabels', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `graph TD
  ...
  test('3: should render a simple flowchart with line breaks', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `
  ...
  test('4: should render a simple flowchart with trapezoid and inverse trapezoid vertex options.', async ({
    page,
  }, testInfo) => {
    await imgSnapshotTest(
      page,
  ...
  test('5: should style nodes via a class.', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `
  ...
  test('6: should render a flowchart full of circles', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `
  ...
  test('7: should render a flowchart full of icons', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `
  ...
  test('8: should render labels with numbers at the start', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `
  ...
  test('9: should render subgraphs', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `
  ...
  test('10: should render subgraphs with a title starting with a digit', async ({
    page,
  }, testInfo) => {
    await imgSnapshotTest(
      page,
  ...
  test('11: should render styled subgraphs', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `
  ...
  test('12: should render a flowchart with long names and class definitions', async ({
    page,
  }, testInfo) => {
    await imgSnapshotTest(
      page,
  ...
  test('13: should render color of styled nodes', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `
  ...
  test('14: should render hexagons', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `
  ...
  test('15: should render a simple flowchart with comments', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `graph TD
  ...
  test('16: Render Stadium shape', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      ` graph TD
  ...
  test('17: Render multiline texts', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `graph LR
  ...
  test('18: Chaining of nodes', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `graph LR
  ...
  test('19: Multiple nodes and chaining in one statement', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `graph LR
  ...
  test('20: Multiple nodes and chaining in one statement', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `graph TD
  ...
  test('21: Render cylindrical shape', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `graph LR
  ...
  test('22: Render a simple flowchart with nodeSpacing set to 100', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `graph TD
  ...
  test('23: Render a simple flowchart with rankSpacing set to 100', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `graph TD
  ...
  test('24: Keep node label text (if already defined) when a style is applied', async ({
    page,
  }, testInfo) => {
    await imgSnapshotTest(
      page,
  ...
  test('25: Handle link click events (link, anchor, mailto, other protocol, script)', async ({
    page,
  }, testInfo) => {
    await imgSnapshotTest(
      page,
  ...
  test('26: Set text color of nodes and links according to styles when html labels are enabled', async ({
    page,
  }, testInfo) => {
    await imgSnapshotTest(
      page,
  ...
  test('27: Set text color of nodes and links according to styles when html labels are disabled', async ({
    page,
  }, testInfo) => {
    await imgSnapshotTest(
      page,
  ...
  test('28: Apply default class to all nodes which do not have another class assigned (htmlLabels enabled)', async ({
    page,
  }, testInfo) => {
    await imgSnapshotTest(
      page,
  ...
  test('29: Apply default class to all nodes which do not have another class assigned (htmlLabels disabled)', async ({
    page,
  }, testInfo) => {
    await imgSnapshotTest(
      page,
  ...
  test('30: Possibility to style text color of nodes and subgraphs as well as apply classes to subgraphs', async ({
    page,
  }, testInfo) => {
    await imgSnapshotTest(
      page,
  ...
  test('31: should not slice off edges that are to the left of the left-most vertex', async ({
    page,
  }, testInfo) => {
    await imgSnapshotTest(
      page,
  ...
  test('32: Render Subroutine shape', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `graph LR
  ...
  test('33: should render a simple flowchart with diagramPadding set to 0', async ({
    page,
  }, testInfo) => {
    await imgSnapshotTest(
      page,
  ...
  test('34: testing the label width in percy', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `graph TD
  ...
  test('35: should honor minimum edge length as specified by the user', async ({
    page,
  }, testInfo) => {
    await imgSnapshotTest(
      page,
  ...
  test('36: should render escaped without html labels', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `graph TD
  ...
  test('37: should render non-escaped with html labels', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `graph TD
  ...
  test('60: handle styling for all node shapes', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `
...
graph TD
  ...
  test('62: fontawesome icons in edge labels', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `
  ...
  test('63: fontawesome icons in edge labels', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `
  ...
  test('64: fontawesome icons in edge labels', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `
  ...
  test('65: text-color from classes', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `
  ...
  test('66: apply class called default on node called default', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `
  ...
  test('67: should be able to style default node independently', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `
  ...
  test('#6369: edge color should affect arrow head', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `
  ...
  test('68: should honor subgraph direction when inheritDir is false', async ({
    page,
  }, testInfo) => {
    await imgSnapshotTest(
      page,
  ...
  test('69: should inherit global direction when inheritDir is true', async ({
    page,
  }, testInfo) => {
    await imgSnapshotTest(
      page,
  ...
  test('70: should render a subgraph with direction TD', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `
...
test('#5824: should be able to render string and markdown labels', async ({ page }, testInfo) => {
  await imgSnapshotTest(
    page,
    testInfo,
    `
...
test('69: should render subgraphs with adhoc list headings', async ({ page }, testInfo) => {
  await imgSnapshotTest(
    page,
    testInfo,
    `
...
test('70: should render subgraphs with markdown headings', async ({ page }, testInfo) => {
  await imgSnapshotTest(
    page,
    testInfo,
    `
