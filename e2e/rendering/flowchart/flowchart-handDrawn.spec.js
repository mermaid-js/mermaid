...
test.describe('Flowchart HandDrawn', () => {
  test('FHD1: should render a simple flowchart no htmlLabels', async ({ page }, testInfo) => {
  ...
  test('FHD2: should render a simple flowchart with htmlLabels', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `graph TD
  ...
  test('FHD3: should render a simple flowchart with line breaks', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `
  ...
  test('FHD4: should render a simple flowchart with trapezoid and inverse trapezoid vertex options.', async ({
    page,
  }, testInfo) => {
    await imgSnapshotTest(
      page,
  ...
  test('FHD5: should style nodes via a class.', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `
  ...
  test('FHD6: should render a flowchart full of circles', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `
  ...
  test('FHD7: should render a flowchart full of icons', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `
  ...
  test('FHD8: should render labels with numbers at the start', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `
  ...
  test('FHD9: should render subgraphs', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `
  ...
  test('FHD10: should render subgraphs with a title starting with a digit', async ({
    page,
  }, testInfo) => {
    await imgSnapshotTest(
      page,
  ...
  test('FHD11: should render styled subgraphs', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `
  ...
  test('FHD12: should render a flowchart with long names and class definitions', async ({
    page,
  }, testInfo) => {
    await imgSnapshotTest(
      page,
  ...
  test('FHD13: should render color of styled nodes', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `
  ...
  test('FHD14: should render hexagons', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `
  ...
  test('FHD15: should render a simple flowchart with comments', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `graph TD
  ...
  test('FHD16: Render Stadium shape', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      ` graph TD
  ...
  test('FHD17: Render multiline texts', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `graph LR
  ...
  test('FHD18: Chaining of nodes', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `graph LR
  ...
  test('FHD19: Multiple nodes and chaining in one statement', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `graph LR
  ...
  test('FHD20: Multiple nodes and chaining in one statement', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `graph TD
  ...
  test('FDH21: Render cylindrical shape', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `graph LR
  ...
  test('FDH22: Render a simple flowchart with nodeSpacing set to 100', async ({
    page,
  }, testInfo) => {
    await imgSnapshotTest(
      page,
  ...
  test('FDH23: Render a simple flowchart with rankSpacing set to 100', async ({
    page,
  }, testInfo) => {
    await imgSnapshotTest(
      page,
  ...
  test('FDH24: Keep node label text (if already defined) when a style is applied', async ({
    page,
  }, testInfo) => {
    await imgSnapshotTest(
      page,
  ...
  test('FDH25: Handle link click events (link, anchor, mailto, other protocol, script)', async ({
    page,
  }, testInfo) => {
    await imgSnapshotTest(
      page,
  ...
  test('FDH26: Set text color of nodes and links according to styles when html labels are enabled', async ({
    page,
  }, testInfo) => {
    await imgSnapshotTest(
      page,
  ...
  test('FDH27: Set text color of nodes and links according to styles when html labels are disabled', async ({
    page,
  }, testInfo) => {
    await imgSnapshotTest(
      page,
  ...
  test('FDH28: Apply default class to all nodes which do not have another class assigned (htmlLabels enabled)', async ({
    page,
  }, testInfo) => {
    await imgSnapshotTest(
      page,
  ...
  test('FDH29: Apply default class to all nodes which do not have another class assigned (htmlLabels disabled)', async ({
    page,
  }, testInfo) => {
    await imgSnapshotTest(
      page,
  ...
  test('FDH30: Possibility to style text color of nodes and subgraphs as well as apply classes to subgraphs', async ({
    page,
  }, testInfo) => {
    await imgSnapshotTest(
      page,
  ...
  test('FDH31: should not slice off edges that are to the left of the left-most vertex', async ({
    page,
  }, testInfo) => {
    await imgSnapshotTest(
      page,
  ...
  test('FDH32: Render Subroutine shape', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `graph LR
  ...
  test('FDH33: should render a simple flowchart with diagramPadding set to 0', async ({
    page,
  }, testInfo) => {
    await imgSnapshotTest(
      page,
  ...
  test('FDH34: testing the label width in percy', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `graph TD
  ...
  test('FDH35: should honor minimum edge length as specified by the user', async ({
    page,
  }, testInfo) => {
    await imgSnapshotTest(
      page,
  ...
  test('FDH36: should render escaped without html labels', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `graph TD
  ...
  test('FDH37: should render non-escaped with html labels', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `graph TD
  ...
  test('FDH40: handle styling with style expressions', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `
  ...
  test('FDH41: handle styling for all node shapes', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `
  ...
  test('FDH42: fontawesome icons in edge labels', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `
graph TD
  ...
  test('FDH43: fontawesome icons in edge labels', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `
  ...
  test('FDH44: fontawesome icons in edge labels', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `
  ...
  test('FDH45: fontawesome icons in edge labels', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `
  ...
  test('FDH46: text-color from classes', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `
  ...
  test('FDH47: apply class called default on node called default', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `
  ...
  test('FDH48: should be able to style default node independently', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `
  ...
  test('FDH49: should add edge animation', async ({ page }, testInfo) => {
    await renderGraph(
      page,
      testInfo,
      `
