...
test.describe('Class diagram V3', () => {
  ...
  test('1.1: should render a simple class diagram without htmlLabels', async ({
    page,
  }, testInfo) => {
    await imgSnapshotTest(
      page,
  ...
  test('2.1: should render a simple class diagrams with cardinality without htmlLabels', async ({
    page,
  }, testInfo) => {
    await imgSnapshotTest(
      page,
  ...
  test('2.2 should render a simple class diagram with different visibilities', async ({
    page,
  }, testInfo) => {
    await imgSnapshotTest(
      page,
  ...
  test('2.3 should render a simple class diagram with different visibilities without htmlLabels', async ({
    page,
  }, testInfo) => {
    await imgSnapshotTest(
      page,
  ...
  test('5.1: should render a simple class diagram with abstract method without htmlLabels', async ({
    page,
  }, testInfo) => {
    await imgSnapshotTest(
      page,
  ...
  test('6.1: should render a simple class diagram with static method without htmlLabels', async ({
    page,
  }, testInfo) => {
    await imgSnapshotTest(
      page,
  ...
  test('7.1: should render a simple class diagram with Generic class without htmlLabels', async ({
    page,
  }, testInfo) => {
    await imgSnapshotTest(
      page,
  ...
  test('11.1: should render a simple class diagram with return type on method without htmlLabels', async ({
    page,
  }, testInfo) => {
    await imgSnapshotTest(
      page,
  ...
  test('12.1: should render a simple class diagram with generic types without htmlLabels', async ({
    page,
  }, testInfo) => {
    await imgSnapshotTest(
      page,
...
`
  ...
  test('should render a simple class diagram with no members if hideEmptyMembersBox is enabled', async ({
    page,
  }, testInfo) => {
    await imgSnapshotTest(
      page,
  ...
  test('should render a simple class diagram with no attributes, only methods', async ({
    page,
  }, testInfo) => {
    await imgSnapshotTest(
      page,
  ...
  test('should render a simple class diagram with no methods, only attributes', async ({
    page,
  }, testInfo) => {
    await imgSnapshotTest(
      page,
  ...
  test('should render a simple class diagram with style definition without htmlLabels', async ({
    page,
  }, testInfo) => {
    await imgSnapshotTest(
      page,
  ...
  test('should render a simple class diagram with classDef definitions', async ({
    page,
  }, testInfo) => {
    await imgSnapshotTest(
      page,
  ...
  test('should render a simple class diagram with classDefs being applied', async ({
    page,
  }, testInfo) => {
    await imgSnapshotTest(
      page,
  ...
  test('should render a simple class diagram with classDefs being applied without htmlLabels', async ({
    page,
  }, testInfo) => {
    await imgSnapshotTest(
      page,
  ...
  test('should render a simple class diagram with markdown styling', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `
  ...
  test('should render a simple class diagram with markdown styling without htmlLabels', async ({
    page,
  }, testInfo) => {
    await imgSnapshotTest(
      page,
  ...
  test('should render a simple class diagram with the handDrawn look', async ({
    page,
  }, testInfo) => {
    await imgSnapshotTest(
      page,
  ...
  test('should render a simple class diagram with styles and the handDrawn look', async ({
    page,
  }, testInfo) => {
    await imgSnapshotTest(
      page,
  ...
  test('should render a simple class diagram with styles and the handDrawn look without htmlLabels', async ({
    page,
  }, testInfo) => {
    await imgSnapshotTest(
      page,
  ...
  test('should render a full class diagram with the handDrawn look', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `
  ...
  test('should render a simple class diagram with a custom theme', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `
  ...
  test('should render a simple class diagram with a custom theme and the handDrawn look', async ({
    page,
  }, testInfo) => {
    await imgSnapshotTest(
      page,
  ...
  test('should render a full class diagram using elk', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `
...
---
  ...
  test('should render nested namespaces with dot notation', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `
  ...
  test('should render syntactically nested namespaces', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `
  ...
  test('should render a namespace with a custom label', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `
  ...
  test('should render compact mode with hierarchicalNamespaces: false', async ({
    page,
  }, testInfo) => {
    await imgSnapshotTest(
      page,
  ...
  test('should render a self-referential class diagram with multiplicity labels (fixes #7560)', async ({
    page,
  }, testInfo) => {
    await imgSnapshotTest(
      page,
