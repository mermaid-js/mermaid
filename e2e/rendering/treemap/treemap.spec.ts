...
test.describe('Treemap Diagram', () => {
  test('1: should render a basic treemap', async ({ page }, testInfo) => {
...
"Category B"
  ...
  test('2: should render a hierarchical treemap', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `treemap-beta
"Products"
  ...
  test('3: should render a treemap with styling using classDef', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `treemap-beta
...
classDef class1 fill:red,color:blue,stroke:#FFD600;
  ...
  test('4: should handle long text that wraps', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `treemap-beta
"Main Category"
  ...
  test('5: should render with a forest theme', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `---
...
"Category B"
  ...
  test('6: should handle multiple levels of nesting', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `treemap-beta
"Level 1"
  ...
  test('7: should handle classDef with multiple styles', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `treemap-beta
...
classDef secondary fill:#6cf,stroke:#333,stroke-dasharray:5 5;
  ...
  test('8: should handle dollar value formatting with thousands separator', async ({
    page,
  }, testInfo) => {
    await imgSnapshotTest(
      page,
...
"Budget"
  ...
  test('8a: should handle percentage formatting', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `---
...
"Market Share"
  ...
  test('8b: should handle decimal formatting', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `---
...
"Metrics"
  ...
  test('8c: should handle dollar sign with decimal places', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `---
...
"Product Prices"
  ...
  test('8d: should handle dollar sign with thousands separator and decimal places', async ({
    page,
  }, testInfo) => {
    await imgSnapshotTest(
      page,
...
"Revenue"
  ...
  test('8e: should handle simple thousands separator', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `---
...
"User Counts"
  ...
  test('8f: should handle valueFormat set via directive with dollar and thousands separator', async ({
    page,
  }, testInfo) => {
    await imgSnapshotTest(
      page,
...
"Sales by Region"
  ...
  test('8g: should handle scientific notation format', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `---
...
"Scientific Values"
  ...
  test('9: should handle a complex example with multiple features', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `---
...
classDef sales fill:#c3a66b,stroke:#333;
  ...
  test('10: should render the example from documentation', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `
  ...
  test('11: should handle comments', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `
  ...
  test('12: should apply classDef fill color to leaf nodes', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `treemap-beta
...
classDef blueClass fill:#0000ff;
  ...
  test('13: should apply classDef stroke styles to sections', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `treemap-beta
...
classDef dashedBorder stroke:black,stroke-dasharray:5,stroke-width:8px;
  ...
  test('14: should apply classDef color to text labels', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `treemap-beta
...
classDef darkText fill:#ecf0f1,color:#000000;
  ...
  test('15: should apply multiple classDef properties simultaneously', async ({
    page,
  }, testInfo) => {
    await imgSnapshotTest(
      page,
...
classDef normal fill:#3498db,color:#fff,stroke:#2980b9,stroke-width:1px;
  ...
  test('16: should handle classDef on nested sections and leaves', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `treemap-beta
...
classDef highlight fill:#f39c12,color:#000,stroke:#e67e22,stroke-width:2px;
  ...
  test('17: should render treemap with readable text on dark theme', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `---
...
"Category B"
  ...
  test('18: should render treemap with readable text on neutral theme', async ({
    page,
  }, testInfo) => {
    await imgSnapshotTest(
      page,
...
"Category B"
  ...
  /*
  test.skip('17: should render a treemap with title', async ({ page }, testInfo) => {
    await imgSnapshotTest(page, testInfo, 
      `
    treemap-beta
  ...
  test.skip('13: should render a treemap with accessibility attributes', async ({ page }, testInfo) => {
    await imgSnapshotTest(page, testInfo, 
      `
    treemap-beta
  ...
  test.skip('14: should render a treemap with title and accessibility attributes', async ({ page }, testInfo) => {
    await imgSnapshotTest(page, testInfo, 
      `
    treemap
  ...
  */
  ...
  test('19: should render labels in complex treemap with many nested blocks', async ({
    page,
  }, testInfo) => {
    await imgSnapshotTest(
      page,
