...
test.describe('Sequence Diagram Special Cases', () => {
  ...
  test.describe('Sequence Diagram Rendering with Different Participant Types', () => {
  ...
  test.describe('Sequence Diagram - New Participant Types with Long Notes and Messages', () => {
  ...
  test.describe('svg size', () => {
    ...
    test.describe('Central Connection Rendering Tests', () => {
    ...
    test.describe('Sequence Diagram Rendering with Autonumber and All Arrow Types', () => {
      test.describe('Autonumber with All Arrow Types', () => {
...
sequenceDiagram
    ...
    Alice()<<-->>()Bob: Dual central bidirectional`,
        ...
        test('should render bidirectional arrows with autonumbering', async ({
          page,
        }, testInfo) => {
          await imgSnapshotTest(
            page,
...
sequenceDiagram
    ...
    Alice\\\\--Bob: Dotted stick bottom reverse`,
      ...
      test.describe('Central Connections with Autonumber - Comprehensive Coverage', () => {
...
sequenceDiagram
    ...
    Alice()\\\\--Bob: Circle at source with dotted stick bottom reverse (RTL)`,
        ...
        test('should render Central_Connection_DUAL ()->>() normal LTR', async ({
          page,
        }, testInfo) => {
          await imgSnapshotTest(
            page,
...
sequenceDiagram
    ...
    Alice()--)()Bob: Circles at both ends with close arrow`,
        ...
        test('should render Central_Connection_DUAL ()->>() normal RTL', async ({
          page,
        }, testInfo) => {
          await imgSnapshotTest(
            page,
...
sequenceDiagram
    ...
    Alice()\\\\--()Bob: Circles at both ends with dotted stick bottom reverse (RTL)`,
        ...
        test('should render mixed central connections with autonumber', async ({
          page,
        }, testInfo) => {
          await imgSnapshotTest(
            page,
...
sequenceDiagram
    ...
    Bob()<<->>Alice: Central at start with bidirectional RTL`,
      ...
      test.describe('Self-Reference Arrows - Comprehensive Coverage', () => {
...
sequenceDiagram
    ...
    test.describe('Comprehensive Test - All Message Types and Arrow Types', () => {
      test('should render all message types and arrow types in a single comprehensive test', async ({
        page,
      }, testInfo) => {
        await imgSnapshotTest(
          page,
...
sequenceDiagram
    ...
    test.describe('Participant Stereotypes with Aliases', () => {
      test('should render participants with stereotypes and aliases', async ({
        page,
      }, testInfo) => {
        await imgSnapshotTest(
          page,
      ...
      test('should render actors with stereotypes and aliases', async ({ page }, testInfo) => {
        await imgSnapshotTest(
          page,
          testInfo,
          `sequenceDiagram
      ...
      test('should render mixed participants and actors with stereotypes and aliases', async ({
        page,
      }, testInfo) => {
        await imgSnapshotTest(
          page,
      ...
      test('should render stereotypes with aliases in boxes', async ({ page }, testInfo) => {
        await imgSnapshotTest(
          page,
          testInfo,
          `sequenceDiagram
      ...
      test('should render stereotypes with aliases and complex interactions', async ({
        page,
      }, testInfo) => {
        await imgSnapshotTest(
          page,
    ...
    test.describe('Participant Inline Alias in Config', () => {
      test('should render participants with inline alias in config object', async ({
        page,
      }, testInfo) => {
        await imgSnapshotTest(
          page,
      ...
      test('should render actors with inline alias in config object', async ({
        page,
      }, testInfo) => {
        await imgSnapshotTest(
          page,
      ...
      test('should handle mixed inline and external alias syntax', async ({ page }, testInfo) => {
        await imgSnapshotTest(
          page,
          testInfo,
          `sequenceDiagram
      ...
      test('should prioritize external alias over inline alias', async ({ page }, testInfo) => {
        await imgSnapshotTest(
          page,
          testInfo,
          `sequenceDiagram
      ...
      test('should render inline alias with only alias field (no type)', async ({
        page,
      }, testInfo) => {
        await imgSnapshotTest(
          page,
