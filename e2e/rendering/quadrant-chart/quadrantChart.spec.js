...
test.describe('Quadrant Chart', () => {
  test('should render if only chart type is provided', async ({ page }, testInfo) => {
  ...
  test('should render a complete quadrant chart', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `
  ...
  test('should render without points', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `
  ...
  test('should able to render y-axis on right side', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `
  ...
  test('should able to render x-axis on bottom', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `
  ...
  test('should able to render x-axis on bottom and y-axis on right', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `
  ...
  test('should render without title', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `
  ...
  test('should use all the config', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `
  ...
  test('should use all the theme variable', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `
  ...
  test('should render x-axis labels in the center, if x-axis has two labels', async ({
    page,
  }, testInfo) => {
    await imgSnapshotTest(
      page,
  ...
  test('should render y-axis labels in the center, if y-axis has two labels', async ({
    page,
  }, testInfo) => {
    await imgSnapshotTest(
      page,
  ...
  test('should render both axes labels on the left and bottom, if both axes have only one label', async ({
    page,
  }, testInfo) => {
    await imgSnapshotTest(
      page,
  ...
  test('it should render data points with styles', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `
  ...
  test('it should render data points with styles + classes', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `
