...
test.describe('C4 diagram (beta)', () => {
  test('C4B.1 should render a context diagram', async ({ page }, testInfo) => {
  ...
  test('C4B.2 should render a container diagram with a nested boundary', async ({
    page,
  }, testInfo) => {
    await imgSnapshotTest(
      page,
  ...
  test('C4B.3 should render bidirectional relationships and tags syntax', async ({
    page,
  }, testInfo) => {
    await imgSnapshotTest(
      page,
  ...
  test('C4B.4 should render a dynamic diagram with numbered steps', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `
  ...
  test('C4B.5 should render a deployment diagram with nested nodes', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `
  ...
  test('C4B.6 should render tag styles from style statements', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `
  ...
  test('C4B.7 should render the live deployment example with instances and an infrastructure node', async ({
    page,
  }, testInfo) => {
    await imgSnapshotTest(
      page,
  ...
  test('C4B.8 should render an auto-generated legend by default', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `
