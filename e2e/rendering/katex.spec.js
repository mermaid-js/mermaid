...
test.describe('Katex', () => {
  test('1: should render a complex Katex flowchart no htmlLabels', async ({ page }, testInfo) => {
  ...
  test('2: should render a Katex flowchart containing the Greek alphabet', async ({
    page,
  }, testInfo) => {
    await imgSnapshotTest(
      page,
  ...
  test('3: should render a Katex flowchart containing set theory symbols', async ({
    page,
  }, testInfo) => {
    await imgSnapshotTest(
      page,
  ...
  // test.skip('4: should render an error box originating from Katex', async ({ page }, testInfo) => {
  ...
  //   );
  // });
  test('4: should render consecutive LaTeX equations separated by text', async ({
    page,
  }, testInfo) => {
    await imgSnapshotTest(
      page,
