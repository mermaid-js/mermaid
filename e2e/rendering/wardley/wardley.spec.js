...
test.describe('Wardley Maps', () => {
  test('1: should render Tea Shop', async ({ page }, testInfo) => {
...
note "A generic note appeared" [0.23, 0.33]
  ...
  test('2: should render Data Evolution Stages', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `
...
evolve Standardized Reports 0.85
  ...
  test('3: should render Pipelines', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `
...
Smart Kettle -> Kettle
  ...
  test('4: should render Link Types and Annotations', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `
...
Service +'backup'> Database
  ...
  test('5: should render Custom Canvas Size', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `
...
evolve Database 0.80
  ...
  test('6: should render GPT Tokeniser Architecture', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `
