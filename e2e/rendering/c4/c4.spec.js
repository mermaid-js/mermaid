...
test.describe('C4 diagram', () => {
  test('C4.1 should render a simple C4Context diagram', async ({ page }, testInfo) => {
  ...
  test('C4.2 should render a simple C4Container diagram', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `
  ...
  test('C4.3 should render a simple C4Component diagram', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `
  ...
  test('C4.4 should render a simple C4Dynamic diagram', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `
  ...
  test('C4.5 should render a simple C4Deployment diagram', async ({ page }, testInfo) => {
    await imgSnapshotTest(
      page,
      testInfo,
      `
  ...
  test('C4.6 should render C4Context diagram with ComponentQueue_Ext', async ({
    page,
  }, testInfo) => {
    await imgSnapshotTest(
      page,
